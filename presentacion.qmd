...
format:
  revealjs:
    ...
    html-header: |
      <style>
        body {
          font-size: 18px; /* Tamaño de fuente global */
        }
        h1 {
          font-size: 36px; /* Tamaño de títulos principales */
        }
        h2 {
          font-size: 28px; /* Tamaño de subtítulos */
        }
        p {
          font-size: 18px; /* Tamaño del texto normal */
        }
      </style>
