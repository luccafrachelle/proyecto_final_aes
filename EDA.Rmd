...
Matches<-readRDS("datos origin/partidos_mundial2022.rds")
Matches_2023<-readRDS("datos origin/partidos_mundialfem2023.rds")
d<-readRDS("datos origin/partidos_mundial_COMPLETO2022.rds") 
d_mundialfem<-readRDS("datos origin/data_mundial2023.rds") %>% 
...
source("datos origin/minutos jugados.R")
source("datos origin/funciones creadas.R")
baseM<-read_rds("datos origin/baseM.rds")
trayM<-read_rds("datos origin/trayM.rds")
baseF<-read_rds("datos origin/baseF.rds")
trayF<-read_rds("datos origin/trayF.rds")
