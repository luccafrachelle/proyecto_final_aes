...
Por otra parte, para el modelo femenino vemos que los porcentajes de error en este modelo particular se reducen cuando lo observamos por equipo siendo Filipinas y Suiza los de mayor error (0.12 y 0.07 respectivamente) pero cayendo considerablemente respecto de los 2 equipos de mayor error en el modelo particual masculino: Costa Rica y Ecuador con 0.32% y 0.28 respectivamente.
